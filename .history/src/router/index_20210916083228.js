...
const routes = [{
    ...
    },
    {
        ...
        children: [{ //二级路由
            ...
            { path: 'acountInfo', component: () =>
                    import ('../components/my/AccountInfo.vue') }, //账户信息
            { path: 'balance', component: () =>
                    import ('../components/my/Balance.vue') }, //我的余额
            { path: 'integral', component: () =>
                    import ('../components/my/Integral.vue') }, //我的积分
            { path: 'discounts', component: () =>
                    import ('../components/my/Discounts.vue') }, //我的优惠
            { path: 'product', component: () =>
                    import ('../components/product/ProductList.vue') }, //产品列表
            { path: 'midifyUser', component: () =>
                    import ('../components/my/MidifyUser.vue') }, //修改用户名
            { path: 'vip', component: () =>
                    import ('../components/my/Vip.vue'), }, //vip页面
    ...
    { path: '/xuandizhi', component: () =>
            import ('../components/address/Xuandizhi.vue') }, // 选择地址
    { path: '/tiandizhi', component: () =>
            import ('../components/address/Tiandizhi.vue') }, // 添加地址
    { path: '/gaidizhi', component: () =>
            import ('../components/address/Gaidizhi.vue') }, // 修改地址
    { path: '/zfdingdan', component: () =>
            import ('../components/Zfdingdan.vue') }, // 支付订单
    { path: '/zfmima', component: () =>
            import ('../components/Zfmima.vue') }, // 支付订单
    {
        ...
        children: [
            { path: "/", component: () =>
                    import ('../components/details/Shangpin.vue'), }, //二级路由-默认
            { path: 'shangpin', component: () =>
                    import ('../components/details/Shangpin.vue') }, //二级路由-商品
            { path: 'pingjia', component: () =>
                    import ('../components/details/Pingjia.vue') }, //二级路由-评价
        ],
        meta: {
            islogin: true
        }
