        ...
        <div class="orderListBox" v-show="0 === number">
          ...
          >
            <div class="orderAll">
              ...
              <div class="center" @click="$router.push('detailsOrder')">
                <div class="one">
                  <div class="pic">
          ...
          <a href="javascript:void(0)" v-for="fail in failList" :key="fail.id">
            <div class="orderAll">
              ...
              <div class="center" @click="$router.push({ path: 'detailsOrder', query: { id: fail.id }})">
                <div class="one">
                  <div class="pic">
    ...
    getsesucceedList() {
      this.axios.get("http://localhost:3000/indent").then((res) => {
        ...
        for (var i = 0; i < chang.length; i++) {
          ...
          } else if (chang[i].result == "已取消") {
            this.failList.push(chang[i]);
          } else if (chang[i].result == "待评价") {
            this.evaluateList.push(chang[i]);
          }
        }
      });
    },
