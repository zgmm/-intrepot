        ...
        <div class="swiper-container">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <li>
                <img src="/images/俏九州.jpeg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>俏九州小炒黄牛肉</p>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/品正品.png" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>品正品港式</p>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/大浪淘沙.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>大浪淘沙哈哈哈</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/御蝶坊.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>御蝶坊老婆饼</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/思密达.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>思密达榴莲千层</p>
                  <p><span>2</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/愿者上钩.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>愿者上钩烤鱼</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/首脑.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>首脑花式发型</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/汤鲜生.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>汤鲜生牛杂五味汤</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/汉阳廷.jpeg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>汉阳廷烤鱼</p>
                  <p><span>1</span>个月前买过</p>
                </div>
            ...
            <div class="swiper-slide">
              <li>
                <img src="/images/桂小厨.jpg" alt="" v-lazy="img"/>
                <div class="gray">
                  <p>桂小厨螺蛳粉</p>
                  <p><span>1</span>个月前买过</p>
                </div>
          ...
          <a href="" v-for="com in getCom" :key="com.lenght">
            <div class="orderAll">
              ...
              <div class="center">
                <div class="one">
                  <div class="pic">
                    <img :src="com.cuisine" alt="" v-lazy="img"/>
                  </div>
                  <p>{{ com.comtitle }}</p>
                </div>
                <div class="two">
          ...
          <a href="">
            <div class="orderAll">
              ...
              <div class="center">
                <div class="one">
                  <div class="pic">
                    <img src="/images/lijiang.jpg" alt="" v-lazy="img"/>
                  </div>
                  <p>新鲜生鱼片...</p>
                </div>
                <div class="two">
                  <div class="pic">
                    <img src="/images/yufeiyan.png" alt="" v-lazy="img"/>
                  </div>
                  <p>红烧大草鱼</p>
                </div>
                <div class="amount">
