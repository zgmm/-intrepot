  ...
  <div>
    ...
    <section class="infoList">
      <ul class="list-ul">
        ...
        <li v-for="item in infoList" :key="item.id" :data-length-n="infoList.length">
          <div class="box">
            <div class="pic">
...
export default {
  ...
  methods: {
    ...
    delete() {
      /* 获取所有的li */
      var list = document.querySelectorAll(".list-ul>li").length;
      console.log(:data-length-n="infoList.length")
