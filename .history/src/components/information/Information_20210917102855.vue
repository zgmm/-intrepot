      ...
      <ul class="list-ul">
        ...
        <li class="tts" v-for="item in infoList" :key="item.id">
          <div class="box tts-box">
            ...
            <div class="delete tts-delete" @click="remove(item.id)">删除</div>
          </div>
        </li>
      </ul>
    </section>
...
export default {
  ...
  methods: {
    ...
    delete() {
      /* 获取所有的li */
      var list = document.querySelectorAll(".tts");
      var box = document.querySelectorAll(".tts-box");
      /* 获取所有的删除按钮 */
      var del = document.querySelectorAll(".tts-delete");
      /* 声明接收移动的位置 */
      var star, move;
      /* 遍历所有的li */
