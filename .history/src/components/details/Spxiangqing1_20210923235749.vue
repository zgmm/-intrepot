  ...
  <div class="box">
    <header>
      ...
      <div class="header-img">
        <img src="../../../public/images/dianpu.jpg" />
      </div>
    ...
    <div class="router">
      <div><router-link to="/spxiangqing1/shangpin">商品</router-link></div>
      <div><router-link to="/spxiangqing1/pingjia">评价</router-link></div>
    </div>
        ...
        if (this.spxqRoute == "/takeaway") {
          ...
          if (this.spxqRoute == "/search") {
            ...
            if(this.spxqRoute == "/detailsOrder"){
              this.$router.push({ path: 'detailsOrder', query: { id : this.detailsid } })
            }else{
