      ...
      <div class="coutainer">
        <div class="bad-box" v-show="0 === number">
          ...
          <ul>
            ...
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">服务态度差</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">额外索取费用</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">餐品翻洒</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">配送慢</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">未穿制服</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">食品凉了</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">未带保温箱</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">着装脏乱</label>
            </li>
            <li>
              <input type="checkbox" id="color1" name="color" />
              <label for="color1">不送上楼</label>
            </li>
