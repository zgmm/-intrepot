<template>
  <div class="Evaluate">
    ...
    <div class="merchant">
      ...
      <div class="star">
        <van-rate v-model="value" :size="30" @change="onChange" color="#FF7618" />
        <p>{{ star }}</p>
        <div class="star-list">
          <div>
            <span class="bao">包装</span>
            <van-rate v-model="packaging" :size="25" @change="onChanges" color="#FF7618"/>
            <span>{{ baozhuang }}</span>
          </div>
          <div>
            <span class="bao">味道</span>
            <van-rate v-model="flavour" :size="25" @change="onChanged" color="#FF7618"/>
            <span>{{ weidao }}</span>
          </div>
          <textarea
            name=""
